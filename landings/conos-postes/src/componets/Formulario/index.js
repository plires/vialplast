...
export default function Formulario() {
  ...
  const sendForm = async (values, { setSubmitting, resetForm }) => {
    ...
    values["origin"] = "Landing Conos y Postes"; // Nombre del origin tal cual figura en Perfit
    values["path"] = "conos-postes"; // nombre de carpeta contenedora
    ...
    try {
      ...
      if (responseData.success) {
        ...
        window.dataLayer.push({
          formLocation: "form_conos_postes",
          event: "send_form_conos_postes",
        });
        resetForm();
      } else {
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-8 offset-md-2">
              <p>
                Contamos con la mayor variedad de cono viales y postes
                rebatibles del mercado poniendo a tu alcance el metodo más
                efectivo y económico de canalizar el tránsito y prevenir
                accidentes.
              </p>
            </div>
          </div>
