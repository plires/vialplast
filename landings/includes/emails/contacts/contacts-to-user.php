    ...
    <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600"
      ...
      <tr>
        <td style="vertical-align: middle;">
          ...
          <img src="{base}img/header-{path}.jpg"
            style="margin:0; padding:0; border:none; display:block; width: 100%; max-width: 600px; height: auto;"
            border="0" alt="header" />
          ...
          <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin: auto;">
            <tr>
              <td class="button-td button-td-primary" style="border-radius: 4px; background: #FFFFFF;">
                <a class="fallback-font button-a button-a-primary" target="_blank" rel="noopener" href="{base}{path}"
                  style="background: #FFFFFF; border: 1px solid #FFFFFF; font-family: 'Montserrat', sans-serif; font-size: 18px; line-height: 28px; font-weight: 700; text-decoration: none; padding: 10px 20px; color: #000000; display: block; border-radius: 4px;">VER
                  MÁS
                </a>
              </td>
            </tr>
      ...
      <tr align="center" style="background-color: #FFFFFF;">
        <td align="center" style="background-color: #FFFFFF;padding: 10px;">
          ...
          <a target="_blank" rel="noopener noreferrer" href="mailto:{email_sales_client}">
            <img src="{base}img/mail.png"
              style="margin:0; margin-right: 20px; padding:0; border:none; display:inline-block; max-width: 32px; width: 32px; height: auto;"
              border="0" alt="mail" />
          </a>

          <a target="_blank" rel="noopener noreferrer" href="{instagram}">
            <img src="{base}img/instagram.png"
              style="margin:0; margin-right: 0; padding:0; border:none; display:inline-block; max-width: 32px; width: 32px; height: auto;"
