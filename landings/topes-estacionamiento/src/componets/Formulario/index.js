...
export default function Formulario() {
  ...
  const sendForm = async (values, { setSubmitting, resetForm }) => {
    ...
    values["origin"] = "Landing Topes de Estacionamiento"; // Nombre del origin tal cual figura en Perfit
    values["path"] = "topes-estacionamiento"; // nombre de carpeta contenedora
    ...
    try {
      ...
      if (responseData.success) {
        ...
        window.dataLayer.push({
          'formLocation': 'form_topes',
          'event': 'send_form_topes'
        });
        resetForm();
      } else {
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-8 offset-md-2">
              <p>
                Topes de estacionamiento en PVC flexible de alta resistencia
                preservan tanto los vehículos como las instalaciones del lugar.
              </p>
            </div>
          </div>
        </div>
