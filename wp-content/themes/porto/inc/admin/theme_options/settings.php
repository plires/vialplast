...
if ( ! class_exists( 'Redux_Framework_porto_settings' ) ) {
	class Redux_Framework_porto_settings {
		...
		public function setSections() {
			...
			$archive_url = esc_url( class_exists( 'PortoBuildersArchive' ) ? admin_url( 'edit.php?post_type=porto_builder&porto_builder_type=archive' ) : admin_url( 'admin.php?page=porto-speed-optimize-wizard&step=general' ) );
			$single_url  = esc_url( class_exists( 'PortoBuildersSingle' ) ? admin_url( 'edit.php?post_type=porto_builder&porto_builder_type=single' ) : admin_url( 'admin.php?page=porto-speed-optimize-wizard&step=general' ) );
			$type_url    = esc_url( class_exists( 'PortoBuildersType' ) ? admin_url( 'edit.php?post_type=porto_builder&porto_builder_type=type' ) : admin_url( 'admin.php?page=porto-speed-optimize-wizard&step=general' ) );
			$header_url  = esc_url( class_exists( 'PortoBuildersHeader' ) ? admin_url( 'edit.php?post_type=porto_builder&porto_builder_type=header' ) : admin_url( 'admin.php?page=porto-speed-optimize-wizard&step=general' ) );
			$shop_url    = esc_url( class_exists( 'PortoBuildersShop' ) ? admin_url( 'edit.php?post_type=porto_builder&porto_builder_type=shop' ) : admin_url( 'admin.php?page=porto-speed-optimize-wizard&step=general' ) );
			$product_url = esc_url( class_exists( 'PortoCustomProduct' ) ? admin_url( 'edit.php?post_type=porto_builder&porto_builder_type=product' ) : admin_url( 'admin.php?page=porto-speed-optimize-wizard&step=general' ) );
			if ( ! empty( $porto_settings_optimize['disabled_pbs'] ) && is_array( $porto_settings_optimize['disabled_pbs'] ) && in_array( 'footer', $porto_settings_optimize['disabled_pbs'] ) ) {
				$footer_url = admin_url( 'admin.php?page=porto-speed-optimize-wizard&step=general' );
			} else {
				$footer_url = admin_url( 'edit.php?post_type=porto_builder&porto_builder_type=footer' );
			}
			$footer_url = esc_url( $footer_url );
			...
			$this->sections[] = array(
				...
				'fields'     => array(
					array(
						...
						'subtitle' => __( 'Controls the theme skin to be light or dark.', 'porto' ),
						'options'  => array(
							''     => __( 'Light', 'porto' ),
							'dark' => __( 'Dark', 'porto' ),
						),
					...
					'fields'     => array(
						...
						array(
							...
							'desc'  => wp_kses(
								...
								sprintf( __( '<strong>Important Note:</strong> <a href="%1$s" target="_blank">Header</a> Builder helps you to develop your site easily. Some below options won\'t be worked well because the priority of the builder widget option is <b>higher</b>.', 'porto' ), $header_url ),
								array(
									'strong' => array(),
									'b'      => array(),
									'a'      => array(
						...
						array(
							'id'     => 'desc_info_sticky_header_layout',
							'type'   => 'info',
							'desc'   => wp_kses(
			...
			$this->sections[] = array(
				...
				'fields'     => array(
					...
					array(
						...
						'desc'     => __( 'If the breadcrumb path isn\'t displayed, please enable <strong>Theme Options/Breadcrumbs/Show Breadcrumbs</strong>.', 'porto' ),
						'default'  => '#777777',
						'validate' => 'color',
					),
					array(
					...
					array(
						...
						'desc'     => __( 'If the title isn\'t displayed, please enable <strong>Theme Options/Breadcrumbs/Show Page Title</strong>.', 'porto' ),
						'default'  => '#ffffff',
						'validate' => 'color',
					),
					array(
			...
			$this->sections[] = array(
				...
				'fields'     => array(
					...
					array(
						...
						'type'     => 'color',
						'title'    => __( 'Hover Background Color', 'porto' ),
						'desc'     => __( 'This works for only default mobile panel type.', 'porto' ),
						'default'  => '#f5f5f5',
						'validate' => 'color',
					),
					array(
			...
			$this->sections[] = array(
				...
				'fields'     => array(
					array(
						...
						'type'   => 'info',
						'desc'   => wp_kses(
							/* translators: %s: Language, Currency switcher layout settings url */
							sprintf( __( 'Go to <a %s>Language, Currency Switcher Layout Settings</a>', 'porto' ), 'href="header-view-currency-switcher" class="goto-section"', 'porto' ),
							array(
								'a' => array(
									'href'  => array(),
									'class' => array(),
			...
			$this->sections[] = array(
				...
				'fields'     => array(
					...
					array(
						'id'    => 'desc_info_search_skin_notice',
						'type'  => 'info',
						'desc'  => wp_kses(
							/* translators: %s: Builder url */
			...
			$this->sections[] = array(
				...
				'fields'     => array(
					array(
						'id'     => 'desc_info_go_switcher_skin',
						'type'   => 'info',
						'desc'   => wp_kses(
							/* translators: %s: Language, Currency switcher skin settings url */
							sprintf( __( 'Go to <a %s>Language, Currency Switcher Skin Settings</a>', 'porto' ), 'href="skin-view-currency-switcher" class="goto-section"', 'porto' ),
							array(
								'a' => array(
									'href'  => array(),
									'class' => array(),
			...
			if ( $this->legacy_mode && class_exists( 'WooCommerce' ) ) { // Header > cart
				$this->sections[] = array(
					...
					'fields'     => array(
						...
						array(
							'id'     => 'desc_info_header_wishlist',
							'type'   => 'info',
							'title'  => __( 'Wishlist', 'porto' ),
							'notice' => false,
						),
						array(
							'id'       => 'wl-offcanvas',
			...
			$this->sections[] = array(
				...
				'fields'     => array(
					array(
						'id'     => 'desc_info_go_mobile_menu_skin',
						'type'   => 'info',
						'desc'   => wp_kses(
			...
			if ( $this->legacy_mode ) {
				...
				$this->sections[] = $this->add_customizer_field(
					array(
						...
						'fields'     => array(
							array(
								'id'     => 'desc_info_go_main_menu_skin',
								'type'   => 'info',
								'desc'   => wp_kses(
			...
			$this->sections[] = $this->add_customizer_field(
				array(
					...
					'fields'     => array(
						array(
							'id'     => 'desc_info_go_breadcrumb_skin',
							'type'   => 'info',
							'desc'   => wp_kses(
					...
					array(
						...
						'fields'     => array(
							...
							array(
								...
								'desc'  => wp_kses(
									/* translators: %s: Builder url */
									sprintf( __( '<strong>Important Note:</strong> <a href="%1$s" target="_blank">Footer</a> Builder helps you to develop your site easily. Some below options won\'t be worked well because the priority of the builder widget option is <b>higher</b>.', 'porto' ), $footer_url ),
									array(
										'strong' => array(),
										'b'      => array(),
										'a'      => array(
							...
							array(
								...
								'type'   => 'info',
								'desc'   => wp_kses(
									__( '<b>Payments:</b> If you use <span>footer builder</span>, below options <span>don\'t</span> work.', 'porto' ),
									array(
										'span' => array(),
										'b'    => array(),
									)
				...
				$this->sections[] = array(
					...
					'fields'     => array(
						array(
							...
							'desc'  => wp_kses(
								/* translators: %s: Builder url */
								sprintf( __( '<strong>Important Note:</strong> <a href="%1$s" target="_blank">Archive</a> & <a href="%2$s" target="_blank">Type</a> Builders help you to develop your site easily. Some below options won\'t be worked well because the priority of the builder widget option is <b>higher</b>.', 'porto' ), $archive_url, $type_url ),
								array(
									'strong' => array(),
									'b'      => array(),
									'a'      => array(
				...
				$this->sections[] = array(
					...
					'fields'     => array(
						array(
							...
							'desc'  => wp_kses(
								/* translators: %s: Builder url */
								sprintf( __( '<strong>Important Note:</strong> <a href="%1$s" target="_blank">Single</a> & <a href="%2$s" target="_blank">Type</a> Builders help you to develop your site easily. Some below options won\'t be worked well because the priority of the builder widget option is <b>higher</b>.', 'porto' ), $single_url, $type_url ),
								array(
									'strong' => array(),
									'b'      => array(),
									'a'      => array(
				...
				$this->sections[] = array(
					...
					'fields'     => array(
						...
						array(
							...
							'type'   => 'info',
							'desc'   => wp_kses(
								__( '<b>Category Filter in Portfolio Page:</b> If you use <span>archive builder</span>, below options <span>don\'t</span> work.', 'porto' ),
								array(
									'span' => array(),
									'b'    => array(),
								)
					...
					array(
						...
						'fields'     => array(
							...
							array(
								...
								'type'   => 'info',
								'desc'   => wp_kses(
									__( '<b>Category Filter in Member Page:</b> If you use <span>archive builder</span>, below options <span>don\'t</span> work.', 'porto' ),
									array(
										'span' => array(),
										'b'    => array(),
									)
							...
							array(
								...
								'type'   => 'info',
								'desc'   => wp_kses(
									__( '<b>Member Type:</b> If you use <span>type builder</span>, below options <span>don\'t</span> work.', 'porto' ),
									array(
										'span' => array(),
										'b'    => array(),
									)
					...
					array(
						...
						'fields'     => array(
							...
							array(
								...
								'type'   => 'info',
								'desc'   => wp_kses(
									__( '<b>Social Links in Single Member:</b> If you use <span>single builder</span>, below options <span>don\'t</span> work.', 'porto' ),
									array(
										'span' => array(),
										'b'    => array(),
									)
							...
							array(
								...
								'type'   => 'info',
								'desc'   => wp_kses(
									__( '<b>Related Members:</b> If you use <span>single builder</span>, below options <span>don\'t</span> work.', 'porto' ),
									array(
										'span' => array(),
										'b'    => array(),
									)
			...
			$this->sections[] = $this->add_customizer_field(
				array(
					...
					'fields'     => array(
						...
						array(
							'id'      => 'desc_info_go_faq_sidebar',
							'type'    => 'info',
							'default' => '',
							'desc'    => wp_kses(
								sprintf(
									/* translators: %s: widgets url */
									__( 'You can control the sidebar in <a href="%s" target="_blank">here</a>.', 'porto' ),
									esc_url( admin_url( 'widgets.php' ) )
								),
								array(
									'a' => array(
						...
						array(
							...
							'type'   => 'info',
							'desc'   => wp_kses(
								__( '<b>Sort Faq Categories:</b> If you use <span>archive builder</span>, below options <span>don\'t</span> work.', 'porto' ),
								array(
									'span' => array(),
									'b'    => array(),
								)
						...
						array(
							...
							'type'   => 'info',
							'desc'   => wp_kses(
								__( '<b>Sort Faq Items:</b> If you use <span>archive builder</span>, below options <span>don\'t</span> work.', 'porto' ),
								array(
									'span' => array(),
									'b'    => array(),
								)
						...
						array(
							...
							'type'   => 'info',
							'desc'   => wp_kses(
								__( '<b>Faq Pagination:</b> If you use <span>archive builder</span>, below options <span>don\'t</span> work.', 'porto' ),
								array(
									'span' => array(),
									'b'    => array(),
								)
				...
				$this->sections[] = array(
					...
					'fields'     => array(
						array(
							...
							'desc'  => wp_kses(
								/* translators: %s: Builder url */
								sprintf( __( '<strong>Important Note:</strong> <a href="%1$s" target="_blank">Product Archive</a> & <a href="%2$s" target="_blank">Type</a> Builders help you to develop shop page easily. Some below options won\'t be worked well because the priority of the builder widget option is <b>higher</b>.', 'porto' ), $shop_url, $type_url ),
								array(
									'strong' => array(),
									'b'      => array(),
									'a'      => array(
				...
				$this->sections[] = array(
					...
					'fields'     => array(
						array(
							...
							'desc'  => wp_kses(
								/* translators: %s: Builder url */
								sprintf( __( '<strong>Important Note:</strong> <a href="%1$s" target="_blank">Single Product</a> & <a href="%2$s" target="_blank">Type</a> Builders help you to develop your site easily. Some below options won\'t be worked well because the priority of the builder widget option is <b>higher</b>.', 'porto' ), $product_url, $type_url ),
								array(
									'strong' => array(),
									'b'      => array(),
									'a'      => array(
