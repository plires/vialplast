		...
		$(document).on('click', '#publish', function (e) {
			...
			if ('publish' == $('#original_post_status').val() && typeof js_porto_admin_vars.wpb_backend_ajax !== 'undefined' && js_porto_admin_vars.wpb_backend_ajax == '1') {
				...
				var $content = $('#content'),
					...
					__ = wp.i18n.__,
					$this = $(this);
				if ('String' == typeof content && 0 == content.indexOf('<p>[')) {
...
/**
 * Redux Section Navigation
 * 
 * @since 6.3.4
 */
(function ($) {
	$(document.body).on('click', '.redux-info-field .goto-section', function (e) {
		e.preventDefault();
		var $this = $(this),
			$section = $this.closest('.redux-group-tab'),
			sectionID = $section.data('rel');

		$('#' + sectionID + '_section_group_li > a').click();
	});
})(jQuery);