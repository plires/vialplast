		...
		<div class="product-image">
			...
			if (count($terms) > 0) {
				...
				foreach ($terms as $term) {
					$term_name = $term->name;
					if ($term_name === 'promo_conos') {
						echo "<img class='promo_list' src='https://vialplast.com.ar/wp-content/themes/vialplast/img/promos/conos/logo-ofertas.large.png' alt='promo list '>";
					}
				}
			}
